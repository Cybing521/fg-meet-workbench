...
CaseName = strcat('./CurrentComp/Y_DispNL_10X10',StrTheory, IntegSchem);
...
%% IMPORTANT SETINGS
%% Initiation 
PositionM=26:80:1546; %CFFF,DOF,26:80:1546;CFCF,DOF,26:80:1466,1方向
PositionMEE =1:200;
%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Y_DispLIN_10X10=Qd(PositionM);
Y_DispNL= XY_Value.Y_Disp;
Y_DispNL_10X10= Y_DispNL(:,end);
X_Disp=0:0.05:1; 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% save file
  save(FileNameRes, 'Y_DispNL_10X10','Qd');
 Y = [0;Y_DispNL_10X10];
hfig = figure;

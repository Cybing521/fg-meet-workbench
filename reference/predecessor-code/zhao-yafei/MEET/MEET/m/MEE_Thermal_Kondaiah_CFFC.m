...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Difine files
InputFile = './InputFile/Kondaiah_CFFC.txt';
OutputFile = [];
...
CaseName = strcat('./CurrentComp/Kondaiah_CFFC',StrTheory, IntegSchem);
...
%% IMPORTANT SETINGS
%% Initiation 
PositionM=26:75:1451; %CFFF,DOF,26:80:1546;CFCF,DOF,26:80:1466,1方向
PositionMEE =1:1000;
%%%%%

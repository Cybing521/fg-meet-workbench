 figure
A1=plot(A(1:4,1),A(1:4,2));
  hold on
 A2=plot(A(1:4,1),A(1:4,3));
 hold on
   A3=plot(A(1:4,1),A(1:4,4));
 hold on
 A4=plot(A(1:4,1),A(1:4,5));
%  hold on
% A5=plot(A(1:5,1),A(1:5,6));
% hold on
%  A6=plot(A(1:5,1),A(1:5,7));
%  hold on
%  A7=plot(A(1:5,1),A(1:5,8));
%  hold on
%  A8=plot(A(1:5,1),A(1:5,9));
%  hold on

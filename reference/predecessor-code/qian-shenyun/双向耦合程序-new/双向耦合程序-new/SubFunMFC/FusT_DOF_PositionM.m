...
%% 矩阵保存
FusT_DOF_PositionM = struct('ClockNodes',ClockNodes,'CoordinateDOFs',CoordinateDOFs,'DOFPerNodeM',DOFPerNodeM,...
...
% CaseName = strcat('./CurrentComp/FusT_DOF_PositionM');

...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Difine files
InputFile = './InputFile/Thermal_SSSScylinder_0.6Vf-15x15-10layer.txt';
OutputFile = [];
...
%% IMPORTANT SETINGS
%% Initiation 
PositionMx=207:223:3106;   %SSSS四边简支圆柱壳，半径600mm，直边300mm，厚度为6mm，网格15X15，y=0.15m时中心线
% PositionMx=6752:5:7047;   %SSSS四边简支圆柱壳，半径600mm，直边300mm，厚度为6mm，网格15X15，x=0.15m时中心线环向位移
PositionMy=1624:5:1689;   %SSSS四边简支圆柱壳，半径600mm，直边300mm，厚度为6mm，网格15X15，x=0.15m时中心线径向位移
PositionMEE =1:2250;
%%%%%
Qd = zeros(FinalDofM,1);
Qv = zeros(FinalDofM,1);

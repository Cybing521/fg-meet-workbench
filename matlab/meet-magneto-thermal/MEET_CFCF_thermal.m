...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Difine files
InputFile = './InputFile/Thermal_CFCFplate_0.6Vf-30x30-10layer.txt';
OutputFile = [];
...
CaseName = strcat('./CurrentComp/Thermal_CFCFplate_0.6Vf-30x30-10layer',StrTheory, IntegSchem);
...
% % PositionMy=2898:5:3098;   %对边固支方板300mm*300mm*6mm，网格20X20，x=0.15m
% PositionMy=108:310:5688;   %对边固支方板300mm*300mm*6mm，网格20X20，y=0m
...
%% IMPORTANT SETINGS
%% Initiation 
PositionMx=78:230:13418;   %CFCF对边固支方板300mm*300mm*6mm，网格30X30，y=0.15m
PositionMy=158:460:13038;   %CFCF对边固支方板300mm*300mm*6mm，网格30X30，y=0m

...
% %% IMPORTANT SETINGS
% %% Initiation 
% PositionMx=73:215:3298;   %CFCF单边固支圆柱壳，半径600mm，直边300mm，厚度为6mm，网格15X15，y=0.15m时中心线
% % PositionMx=6752:5:7047;   %CFCF单边固支圆柱壳，半径600mm，直边300mm，厚度为6mm，网格15X15，x=0.15m时中心线环向位移
% PositionMy=1653:5:1718;   %CFCF单边固支圆柱壳，半径600mm，直边300mm，厚度为6mm，网格15X15，x=0.15m时中心线径向位移
% PositionMEE =1:2250;
% %%%%%
% Qd = zeros(FinalDofM,1);
% Qv = zeros(FinalDofM,1);

...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Difine files
InputFile = './InputFile/Thermal_CCCCplate_0.6Vf-30x30-10layer.txt';
OutputFile = [];
...
CaseName = strcat('./CurrentComp/Thermal_CCCCplate_0.6Vf-30x30-10layer',StrTheory, IntegSchem);
...
% %% IMPORTANT SETINGS
% %% Initiation 
% PositionMx=48:145:5558;   %CCCC四边固支方板300mm*300mm*6mm，网格20X20，y=0.15m固定端沿自由端中心
% PositionMy=2708:5:2898;   %CCCC四边固支方板300mm*300mm*6mm，网格20X20，x=0.15m
% PositionMEE =1:4000;
% %%%%%
...
%% IMPORTANT SETINGS
%% Initiation 
PositionMx=73:220:12833;   %CCCC四边固支方板300mm*300mm*6mm，网格30X30，y=0.15m
PositionMy=6308:5:6598;   %CCCC四边固支方板300mm*300mm*6mm，网格30X30，x=0.15m
PositionMEE =1:9000;
%%%%%
Qd = zeros(FinalDofM,1);
Qv = zeros(FinalDofM,1);

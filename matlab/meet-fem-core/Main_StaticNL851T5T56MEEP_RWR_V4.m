...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [XY_Value,QFdva] = Main_StaticNL851T5T56MEEP_RWR_V4(InputFile, ...
...
Tot_DOF_MEE = length(KffMT(:,1));   
 %%% first calculation
    if IterationIndex == 1
        ...
        DQd0 = KuuT0\(DLamda0*FueT-DLamda0*KufMT0*PhiaMT-DLamda0*KuzT0*MgaT-DLamda0*KutT0*DeltaT);
        ...
        DQd1_1 = KuuT1\(FueT - KufMT1*PhiaMT - KuzT1*Mga - KutT1*DeltaT);
        DQd1_2 = KuuT1\FR1;

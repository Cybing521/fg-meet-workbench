...
- [x] 选取 e₀=0.2 / U / Vf0.5 作为动力代表工况，并完成 10x10 完整 Newmark pilot
- [x] 整理动力结果：`output/dynamic_porous_U_Vf50_e20_Even_10x10_*.csv` 与 `reports/2026-06-01-porous-dynamic/`
- [ ] 30x30 含孔隙模态降阶 + 频率退化分析
